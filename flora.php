...
// Get filter options
$habitat_options = mysqli_query($conn, "SELECT DISTINCT habitat FROM flora ORDER BY habitat");
$status_options = mysqli_query($conn, "SELECT DISTINCT status_konservasi FROM flora ORDER BY status_konservasi");
?>
...
<body>
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="flora.php" class="nav-link active"><i class="fas fa-seedling"></i> Flora</a></li>
                <li><a href="fauna.php" class="nav-link"><i class="fas fa-paw"></i> Fauna</a></li>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <p class="page-description">
                    Jelajahi keanekaragaman tumbuhan Indonesia yang menakjubkan. 
                    Temukan berbagai spesies flora dari Sabang sampai Merauke dengan informasi lengkap dan gambar berkualitas tinggi.
                </p>
    ...
    <!-- Flora Grid Section -->
    <section class="flora-grid-section">
        <div class="container">
                        ...
                        <div class="flora-card">
                            <div class="card-image">
                                <img src="<?php echo $flora['image']; ?>" alt="<?php echo $flora['nama']; ?>" 
                                     onerror="this.src='assets/images/default-flora.jpg'">
                            ...
                            <div class="card-content">
                                ...
                                <p class="card-description"><?php echo substr($flora['deskripsi'], 0, 120); ?>...</p>
                                <div class="card-info">
                                    <div class="info-item">
                                        <i class="fas fa-map-marker-alt"></i>
                                        <span><?php echo $flora['asal_daerah']; ?></span>
                                    </div>
                                    <div class="info-item">
                                        <i class="fas fa-tree"></i>
                                        <span><?php echo $flora['habitat']; ?></span>
                                    </div>
                                </div>
                                <div class="card-tags">
            ...
            <?php else: ?>
                <div class="no-results">
                    <i class="fas fa-search"></i>
                    <h3>Tidak ada flora yang ditemukan</h3>
                    <p>Coba ubah kata kunci pencarian atau filter yang digunakan</p>
                    <a href="flora.php" class="btn btn-primary">
