...
if ($_POST) {
    ...
    // Handle image upload
    $image_path = 'assets/images/default-flora.svg';
    if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (in_array($file_extension, $allowed_extensions)) {
            if ($_FILES['image']['size'] <= 5 * 1024 * 1024) { // 5MB limit
                $new_filename = 'flora_' . time() . '_' . uniqid() . '.' . $file_extension;
    ...
    if (empty($error_message)) {
        $query = "INSERT INTO flora (nama, nama_ilmiah, deskripsi, habitat, habitat_detail, asal_daerah, status_konservasi, manfaat, ciri_khusus, image) 
                  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
<head>
    ...
    <title>Tambah Flora - EduFlora Admin</title>
                ...
                <div class="form-container">
                    <div class="form-header">
                        <h2>
                            ...
                            Informasi Flora Baru
                        </h2>
                        <p>Lengkapi semua informasi tentang flora yang akan ditambahkan ke database</p>
                    </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <small class="form-help">Nama umum flora dalam bahasa Indonesia</small>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="habitat" name="habitat" required>
                                        ...
                                        <option value="Savana" <?php echo ($_POST['habitat'] ?? '') === 'Savana' ? 'selected' : ''; ?>>Savana</option>
                                        ...
                                        <option value="Mangrove" <?php echo ($_POST['habitat'] ?? '') === 'Mangrove' ? 'selected' : ''; ?>>Mangrove</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-help">Daerah asal atau sebaran flora</small>
                                </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="deskripsi" name="deskripsi" required rows="5" 
                                          placeholder="Tuliskan deskripsi lengkap tentang flora ini..."><?php echo htmlspecialchars($_POST['deskripsi'] ?? ''); ?></textarea>
                                <small class="form-help">Deskripsi lengkap tentang flora (minimal 100 karakter)</small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="manfaat" name="manfaat" rows="3" 
                                          placeholder="Jelaskan manfaat flora ini bagi manusia dan lingkungan..."><?php echo htmlspecialchars($_POST['manfaat'] ?? ''); ?></textarea>
                                <small class="form-help">Manfaat flora bagi manusia, lingkungan, atau ekosistem</small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="ciri_khusus" name="ciri_khusus" rows="3" 
                                          placeholder="Jelaskan ciri-ciri khusus yang membedakan flora ini..."><?php echo htmlspecialchars($_POST['ciri_khusus'] ?? ''); ?></textarea>
                                <small class="form-help">Ciri-ciri khusus atau unik dari flora ini</small>
                            </div>
                        </div>
